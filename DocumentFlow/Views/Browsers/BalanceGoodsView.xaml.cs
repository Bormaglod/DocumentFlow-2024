...
/// <summary>
/// Логика взаимодействия для BalanceGoodsView.xaml
/// </summary>
public partial class BalanceGoodsView : UserControl, IGridPageView, ISelfTransientLifetime
{
    public BalanceGoodsView()
    {
        InitializeComponent();
    }
